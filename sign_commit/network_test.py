...
def deploy_contract(w3, contract_interface, account):
    ...
    transaction = contract.constructor().build_transaction({
        ...
        "chainId": 11155111,  # Sepolia test network chain ID
...
# Infura URL for Sepolia test network
...
# Check balance
wallet = w3.to_checksum_address('0x092da123323d3c643284D296d99C863A354B93Ca')
print("balance:" + str(w3.eth.get_balance(wallet)))

is_addr = w3.is_address('0x440fa25297726C9e8A30fb4EAdA7EE30D0FDC8dD')
